...
from extention1 import ExchangeException, Exchange
...
def get_price(message: telebot.types.Message):
    ...
    #MyCryptoConverter = CryptoConverter()
        total_price = Exchange.get_price(quote, base, amount)
